...
fn main() {
	...
	println!("first_subword({}) = {}", s1, first_subword(s1)); // Must print first_subword(helloWorld) = hello
	println!("first_subword({}) = {}", s2, first_subword(s2)); // Must print first_subword(snake_case) = snake
	println!("first_subword({}) = {}", s3, first_subword(s3)); // Must print first_subword(CamelCase) = Camel
	println!("first_subword({}) = {}", s4, first_subword(s4)); // Must print first_subword(just) = just
}
