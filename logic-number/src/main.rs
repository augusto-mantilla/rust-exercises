...
// For this you have to create a function number_logic that will take a number and return true
// if the number is the sum of its own digits, each raised to the power
// of the number of digits, and false otherwise.
//
// For example:
//
...
fn main() {
    ...
    for pat in &array {
        ...
        println!("this number returns {} because the number {} obey the rules of the sequence", number_logic(*pat),pat )
    }
